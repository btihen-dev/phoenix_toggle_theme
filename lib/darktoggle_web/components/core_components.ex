defmodule DarktoggleWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(DarktoggleWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(DarktoggleWeb.Gettext, "errors", msg, opts)
    end
  end
